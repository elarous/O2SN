...
The `home-routes` handler in the `o2sn.routes.home` namespace
...
The `home-page` function will in turn call the `o2sn.layout/render` function
...
The rest of this page is rendered by ClojureScript found in the `src/cljs/o2sn/core.cljs` file.



#### Organizing the routes

The routes are aggregated and wrapped with middleware in the `o2sn.handler` namespace:
...
Request middleware functions are located under the `o2sn.middleware` namespace.

This namespace is reserved for any custom middleware for the application. Some default middleware is
already defined here. The middleware is assembled in the `wrap-base` function.

Middleware used for development is placed in the `o2sn.dev-middleware` namespace found in
