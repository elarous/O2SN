...
(def request {:aleph/request-arrived 333767016959685,
...
(def access-control {:access-control-allow-methods #{:get :delete :post :put},
...
;; (def res1 (handle-cors (debug identity) request access-control add-access-control))
